    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResevationOrigins", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResturantAreas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ResturantAreas_Restaurants_RestaurantId",
...
<<<<<<<< HEAD:Migrations/20231014045004_init.cs
...
>>>>>>>> FullCalenderCopy:Migrations/20230922231500_initial.cs
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Sittings_SittingTypes_TypeId",
                        column: x => x.TypeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RestaurantTables_ResturantAreas_RestaurantAreaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reservations_ResevationOrigins_ResevationOriginId",
                        column: x => x.ResevationOriginId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationRestaurantTable", x => new { x.RestaurantTablesId, x.reservationsId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReservationRestaurantTable_RestaurantTables_RestaurantTablesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResturantAreas_RestaurantId",
                table: "ResturantAreas",
                column: "RestaurantId");
